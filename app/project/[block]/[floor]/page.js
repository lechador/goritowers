...
export default async function page({params}) {
  const floorData = await axios.get(`${process.env.ENV=='dev' ? process.env.HOST : `https://${process.env.NEXT_PUBLIC_VERCEL_URL}:3000`}/api/blocks/${params.block}/floors/${params.floor}`);
