      ...
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracki uppercase dark:text-gray-50">პროექტები</h3>
            <ul className="space-y-1">
              <li>
                <Link href="/project">გორი თაუერსი</Link>
              </li>
            </ul>
          </div>
          <div className="space-y-3">
            <h3 className="tracki uppercase dark:text-gray-50">კომპანია</h3>
            <ul className="space-y-1">
              <li>
          ...
          <div className="space-y-3">
            <div className="uppercase dark:text-gray-50">მოგვძებნე ინტერნეტში</div>
